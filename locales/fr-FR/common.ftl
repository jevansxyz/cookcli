...
new-recipe-directory = Dossier de la recette
new-recipe-directory-placeholder = ex. Diner/Italien
new-recipe-directory-hint = Laisser vide pour sauvegarder dans le dossier racine
new-recipe-name = Nom de la recette
new-recipe-placeholder = Pates Carbonara
new-recipe-hint = Le nom de fichier de la recette
